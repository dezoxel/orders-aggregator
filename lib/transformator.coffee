...
# }
  ...
  user_entry_to_dish_type: (raw_user_entry) ->
    ...
    switch user_entry
      when 'x', 'х', 'целая' # latin & cyrillic
        'Целых'
      when 'без мяса', 'без м\'яса'
        'Без мяса'
      when 'без салата', 'без салата', 'без салату'
        'Без салата'
      when 'без гарнира'
        'Без гарнира'
      when 'салат', 'только салат'
        'Только салат'
      when 'м’ясо', 'только мясо'
        'Только мясо'
      when '0.5', '0,5'
        '0.5'
      when '0.5 без мяса', '0,5 без мяса'
        '0.5 без мяса'
      when '0.5 без салата', ' 0.5 без салату', '0,5 без салата', ' 0,5 без салату'
        '0.5 без салата'
      when '0.5 без гарнира', '0,5 без гарнира'
        '0.5 без гарнира'
      when '0.5 салата', '0,5 салата'
        '0.5 салата'
      when '2x', '2X'
        'Целых': 2
      else
